...
from apps.core.bootstrap.seed_business import seed_growth, seed_smart_site_factory
from apps.core.bootstrap.seed_core import seed_core_platform


class Command(BaseCommand):
    help = "Seed do Growth Engine."
    ...
    def handle(self, *args, **options):
        ...
        seed_growth(ctx)
        self.stdout.write(self.style.SUCCESS("Seed growth concluido."))
