...
KNOWLEDGE_ITEMS = [
    ...
    },
    {
        ...
        "content": "A Xyron Robotics é uma empresa de tecnologia robótica com soluções voltadas para educação, recepção, atendimento, segurança, limpeza, saúde, entrega, inspeção e operação autônoma. A página geral /solucoes/xyron-robotics/ funciona como vitrine resumida da linha Xyron, enquanto as páginas individuais detalham cada robô. A Smart Control Brasil atua conectando essas soluções a aplicações reais, apoiando diagnóstico, escolha do robô, implantação, treinamento e integração conforme o ambiente do cliente. Principais linhas: LIRO / LittleBot para educação e inclusão; NeoBot para recepção e atendimento inteligente; HygiBot / Dune Bot para limpeza autônoma; OrbitBot / Patrol Bot para segurança e patrulhamento; Buddy Bot para inspeção, segurança e áreas de difícil acesso; WaiterBot para entrega e apoio operacional; CareBot para saúde e cuidado assistivo; HostBot para recepção e eventos; MowerBot para corte de grama e áreas externas.",
    },
    {
