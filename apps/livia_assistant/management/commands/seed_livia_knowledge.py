...
KNOWLEDGE_ITEMS = [
    ...
    },
    {
        ...
        "category": LiviaKnowledgeItem.Category.TECHNICAL,
        "priority": 94,
        "keywords": "xyron robótica robos xyron soluções xyron robô inteligente robotica inteligente smart control xyron",
        "content": "A Xyron Robotics trabalha com robótica inteligente aplicada a educação, recepção, atendimento, segurança, patrulhamento, limpeza, entrega, saúde, inspeção e ambientes especiais. A Smart Control Brasil apoia o diagnóstico da aplicação, escolha da solução, integração e implantação conforme o ambiente do cliente.",
    },
    {
        ...
        "content": "O LIRO, também chamado LittleBot, é um robô educacional inteligente voltado para escolas, famílias, creches, clínicas e espaços de atendimento especializado. Ele apoia interação, aprendizagem, entretenimento e inclusão, com resposta por voz, reconhecimento facial, controle por voz/toque, chamada de vídeo, conversa com ChatGPT, assistente de vida e monitoramento remoto.",
    },
    {
        ...
        "category": LiviaKnowledgeItem.Category.TECHNICAL,
        "priority": 92,
        "keywords": "orbit orbit bot patrol patrol bot robô de segurança robo de segurança patrulhamento ronda monitoramento visão térmica camera termica segurança patrimonial",
        "content": "O Orbit Bot, também tratado como Patrol Bot em aplicações de patrulhamento, é um robô de segurança para grandes áreas. Possui navegação autônoma, rotas programadas, identificação visual por IA, monitoramento em tempo real e apoio à prevenção de riscos. Pode reconhecer pessoas, fumaça e alta temperatura, emitindo alertas conforme o projeto.",
    },
    {
        "title": "Neo Bot",
        "slug": "xyron-neo-bot",
        "category": LiviaKnowledgeItem.Category.TECHNICAL,
        "priority": 91,
        "keywords": "neo neo bot neobot robô de recepção robo de recepção robô recepcionista robo recepcionista atendimento recepção eventos visitantes chatbot físico atendimento com ia recepcionista robô",
        "content": "O Neo Bot é um robô de recepção e atendimento da linha Xyron, indicado para empresas, eventos, escolas, lojas e ambientes que desejam criar uma experiência interativa com visitantes e clientes. Ele pode conversar em múltiplos idiomas, usar IA como ChatGPT/DeepSeek, responder perguntas personalizadas, reconhecer rostos, apresentar produtos e apoiar ações comerciais. No catálogo, possui dimensões de 45 x 100 x 40 cm, peso de 18 kg, tela HD de 10,1 polegadas, bateria de 20.000 mAh, autonomia de até 10 horas e carregamento aproximado de 9 horas.",
    },
    {
        "title": "WaiterBot",
    ...
    },
    {
        ...
        "content": "O HygiBot, também tratado comercialmente como Dune/Duno Bot em algumas conversas, é um robô de limpeza autônoma para grandes áreas internas. Ele combina funções como lavar, varrer, aspirar e passar pano seco, apoiando equipes de limpeza com operação inteligente, monitoramento de status e relatórios.",
    },
    {
        "title": "HostBot",
        "slug": "xyron-hostbot",
